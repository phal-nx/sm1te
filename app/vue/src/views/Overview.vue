  ...
  <d-container fluid class="main-content-container px-4">
    ...
    <d-row no-gutters class="page-header py-4">
      <d-col col sm="4" class="text-center text-sm-left mb-4 mb-sm-0">
        ...
        <h3 class="page-title">Sm1te Overview</h3>
      </d-col>
    </d-row>
...
import TopVulns from '@/components/common/TopVulns.vue';
//import CountryReports from '@/components/common/CountryReports.vue';
import HostsOverview from '@/components/blog/HostsOverview.vue';
import HostsByDevice from '@/components/blog/HostsByDevice.vue';
...
export default {
  components: {
    SmallStats,
    boHostsOverview: HostsOverview,
    boHostsByDevice: HostsByDevice,
    boDiscussions: Discussions,
//    boCountryReports: CountryReports,
    boTopVulns: TopVulns
  },
  data() {
    return {
