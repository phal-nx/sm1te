    ...
    <d-card-footer class="border-top">
      <d-row>
        ...
        <d-col class="text-center view-report">
          <d-button type="submit" class="btn-white" @click="handleClick('view-all-comments')">View All Action Items</d-button>
        </d-col>
...
const defaultDiscussionsData = [{
  ...
  post: {
    title: 'Widespread apache issues',
    url: '#',
  },
  body: 'Should we be concerned about how many apache2 servers are vulnerable',
}, {
  id: 2,
  date: '4 days ago',
  author: {
  ...
  body: 'Unfortunately we cannot patch Redis, as it breaks the API we use, we\'ve worked around this in our IDS/IPS',
}, {
  id: 3,
  date: '5 days ago',
  author: {
  ...
  body: 'Nginx instances have all been updated.',
}];
...
export default {
  ...
  props: {
    ...
    title: {
      type: String,
      default: 'Discussions and Action Items',
    },
    /**
